...
;// CONCATENATED MODULE: ./wwwroot/ts/components/FetchData.tsx
...
;// CONCATENATED MODULE: ./wwwroot/ts/components/Form.tsx
...
;// CONCATENATED MODULE: ./wwwroot/ts/source/CommonHelper.tsx
var Language;
(function (Language) {
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/CardLabel.tsx
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/HazardId.tsx




class HazardId extends react.Component {
    constructor(props) {
        super(props);
        this.labels = new Map();
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/LSA.tsx


class LSA extends react.Component {
    constructor(props) {
        super(props);
        this.labels = new Map();
        this.onChange = (e) => {
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/ReportType.tsx
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/SafeChoice.tsx


class SafeChoice extends react.Component {
    constructor(props) {
        super(props);
        this.labels = new Map();
        this.onChange = (e) => {
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/Card.tsx
...
class Card extends react.Component {
    ...
    send() {
        ...
        CommonHelper.fetch("/api/cards", HttpMethod.post, body)
            .then(res => {
            if (res.status == "ok") {
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/Auth.tsx
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/MyParticipation.tsx
...
;// CONCATENATED MODULE: ./wwwroot/ts/pages/CardApp.tsx
...
react_dom.render(react.createElement(CardApp, null), document.getElementById("main"));
